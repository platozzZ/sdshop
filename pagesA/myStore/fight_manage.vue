		...
		<div class='relative'>
			<div class='topTabBar'>
				...
				<div class='width_25' @tap='changeTabBar(4)' >
					<div style="width: 50%;" :class='{"active":topTabBar==4}'>
						拼团成功
					</div>
				</div>

				<div class='width_25' @tap='changeTabBar(5)' >
					<div style="width: 50%;" :class='{"active":topTabBar==5}'>
						拼团中
					</div>
				</div>
				
				<div class='width_25' @tap='changeTabBar(6)' >
					<div style="width: 50%;" :class='{"active":topTabBar==6}'>
						拼团失败
					</div>
				</div>
